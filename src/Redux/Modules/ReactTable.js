...
export const SUCCESS_DATA_CHANGE = 'SECCESS_DATA_CHANGE'
/*
...
// Async functions
export const GetData = (uri, entity, columns, page, pageSize) => async (dispatch) => {
