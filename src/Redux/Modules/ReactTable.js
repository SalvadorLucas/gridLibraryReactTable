...
export const UPDATE_ROWS_SELECTED = 'UPDATE_ROWS_SELECTED'
...
// Async functions
export const GetData = (uri, entity, columns, callStandard, page, pageSize, columnsToFilter, value) => async (dispatch) => {
  switch (callStandard.toLowerCase()) {
    case 'brapi':
      dispatch(ApiWrapi(uri, entity, columns))
      break
    case 'graphql':
      dispatch(ApiGraphQL(uri, entity, columns, page, pageSize, columnsToFilter, value))
      break
    default:
      return
  }
...
export const ApiGraphQL = (uri, entity, columns, page, pageSize, columnsToFilter, value) => async (dispatch) => {
